      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center px-3 py-6 sm:px-6 sm:py-12">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="text-center">
            ...
            <h2 className="mt-2 sm:mt-3 text-xl sm:text-3xl font-extrabold text-gray-900">Check your email</h2>
          ...
          <div className="mt-4 sm:mt-8 text-center">
            <Link href="/login" className="text-xs sm:text-sm font-medium text-purple-600 hover:text-purple-500">
              Return to login
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center px-3 py-6 sm:px-6 sm:py-12">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="text-center">
          <h2 className="text-xl sm:text-3xl font-extrabold text-gray-900">Forgot your password?</h2>
          <p className="mt-1 sm:mt-2 text-sm text-gray-600">
