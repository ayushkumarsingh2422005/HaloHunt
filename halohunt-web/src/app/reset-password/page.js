      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center px-4 py-8 sm:px-6 sm:py-12">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="text-center">
            ...
            <h2 className="mt-3 text-xl font-medium text-gray-900">Verifying your reset link</h2>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center px-4 py-8 sm:px-6 sm:py-12">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="text-center">
            ...
            <h2 className="mt-3 text-2xl sm:text-3xl font-extrabold text-gray-900">Invalid or expired link</h2>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center px-4 py-8 sm:px-6 sm:py-12">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="text-center">
            ...
            <h2 className="mt-3 text-2xl sm:text-3xl font-extrabold text-gray-900">Password reset successful</h2>
            <p className="mt-2 text-sm text-gray-600">
            ...
            <div className="mt-6">
              <Link 
                href="/login" 
                className="inline-flex items-center px-4 py-2.5 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
              >
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-2 sm:py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-purple-500 focus:border-purple-500 text-base"
                  placeholder="••••••••"
                />
